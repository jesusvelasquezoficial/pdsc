  ...
  <app-card v-if="loadedGraphPetroleo" heading="Petroleo de Venezuela" :headingMenu="true">
    ...
    <div class="mb-1 ml-4 d-flex justify-content-start align-items-center">
      ...
      <div class="col-sm-8 col-md-10 col-lg-7">
        <b-button @click="sP7D" size="sm" variant="outline-dark"><small>7d</small></b-button>
        <b-button @click="sP2S" size="sm" variant="outline-dark"><small>2s</small></b-button>
        <b-button @click="sP30D" size="sm" variant="outline-dark"><small>1m</small></b-button>
        <b-button @click="resertScalePetroleo" size="sm" variant="outline-dark"><small>3m</small></b-button>
        <b-button @click="resertScalePetroleo" size="sm" variant="outline-dark"><small>1y</small></b-button>
        <!-- <b-button @click="resertScalePetroleo" size="sm" variant="outline-dark">YTD</b-button> -->
        <b-button @click="resertScalePetroleo" size="sm" variant="outline-dark"><small>ALL</small></b-button>
      </div>
    </div>
    <!-- Graficos de linea -->
    <line-chart
